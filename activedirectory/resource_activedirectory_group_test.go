...
func TestAccADGroup_basic(t *testing.T) {
	...
	user_base := strings.ToLower(os.Getenv("AD_TEST_USER_BASE"))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccResourceADGroupTestData(ou, name, description,user_base,false),
...
func TestResourceADGroupObjectCreate(t *testing.T) {
	...
	t.Run("resourceADGroupObjectCreate - should return nil when everything is good", func(t *testing.T) {
		...
		api.On("createGroup", mock.Anything, mock.Anything, mock.Anything,mock.Anything,mock.Anything,mock.Anything).Return(nil)
		api.On("getGroup", mock.Anything, mock.Anything, mock.Anything,mock.Anything,mock.Anything,mock.Anything).Return(testGroup, nil)
	...
	t.Run("resourceADGroupObjectCreate - should return error when creating failed", func(t *testing.T) {
		api := new(MockAPIInterface)
		api.On("createGroup", mock.Anything, mock.Anything, mock.Anything,mock.Anything,mock.Anything,mock.Anything).Return(fmt.Errorf("error"))
	...
	t.Run("resourceADGroupObjectCreate - id should be set to dn", func(t *testing.T) {
		...
		api.On("getGroup", mock.Anything, mock.Anything, mock.Anything,mock.Anything,mock.Anything).Return(testGroup, nil)
